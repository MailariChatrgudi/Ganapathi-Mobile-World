...
const products = [
  {
    ...
    images: [
      'https://rukminim2.flixcart.com/image/1408/1408/xif0q/mobile/q/q/t/-original-imahbzpzhcptykzf.jpeg?q=90',
    ],
  ...
  },
  {
    ...
    images: [
      'https://rukminim2.flixcart.com/image/1408/1408/xif0q/mobile/a/i/k/m55s-sm-m558b-samsung-original-imah5wyg6jqmh3uv.jpeg?q=90',
    ],
  ...
  },
  {
    ...
    images: [
      'https://rukminim2.flixcart.com/image/1408/1408/xif0q/mobile/r/w/j/12r-cph2585-oneplus-original-imah9zk6nddhcbsh.jpeg?q=90',
    ],
  ...
  },
  {
    ...
    images: [
      'https://rukminim2.flixcart.com/image/1408/1408/xif0q/mobile/g/2/u/nord-ce4-cph2613-oneplus-original-imahjjynmkftmy4h.jpeg?q=90',
    ],
  ...
  },
  {
    ...
    images: [
      'https://rukminim2.flixcart.com/image/1408/1408/xif0q/mobile/o/g/3/v30-5g-v2318-vivo-original-imagyzhhxumayhzw.jpeg?q=90',
    ],
  ...
  },
  {
    ...
    images: [
      'https://rukminim2.flixcart.com/image/1408/1408/xif0q/mobile/d/x/1/-original-imah4kxes2ktzf9f.jpeg?q=90',
    ],
    ...
    isLimitedStock: false, isFeatured: false
  },
  {
    ...
    images: [
      'https://rukminim2.flixcart.com/image/1408/1408/xif0q/mobile/z/i/n/-original-imah3cmbp39chuhr.jpeg?q=90',
    ],
  ...
  },
  {
    ...
    images: [
      'https://rukminim2.flixcart.com/image/1408/1408/xif0q/mobile/h/9/x/-original-imah4d9fsyvwp7yz.jpeg?q=90',
    ],
  ...
  },
  {
    ...
    images: [
      'https://rukminim2.flixcart.com/image/1408/1408/xif0q/mobile/d/q/y/gt-6t-5g-rmx3853-realme-original-imahfddqupz7zzmh.jpeg?q=90',
    ],
  ...
  },
  {
    ...
    images: [
      'https://rukminim2.flixcart.com/image/1408/1408/xif0q/mobile/8/6/m/narzo-70-pro-5g-narzo-70-pro-5g-realme-original-imagz5m63fhjgg2z.jpeg?q=90',
    ],
  ...
  },
  {
    ...
    images: [
      'https://rukminim2.flixcart.com/image/1408/1408/xif0q/mobile/u/5/f/-original-imagwu9fyya8h6mg.jpeg?q=90',
    ],
    price: 29999, mrp: 33999, discount: 12,
  ...
  },
  {
    ...
    images: [
      'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSj0t8XyNGsLLrNFTX-s3dMBjvXb58U_Lk0PA&s',
    ],
...
const googleReviews = [
  { name: 'Rajesh Kumar', rating: 5, comment: 'Best price in Koppal! Got my Samsung Galaxy at ₹2000 less than other shops. Very professional staff and quick service.', product: null },
  { name: 'Priya Sharma', rating: 5, comment: 'Excellent service! My phone screen was repaired in just 1 hour. Ganapathi Mobile World is the best mobile shop in Koppal.', product: null },
  { name: 'Mohammed Imran', rating: 4, comment: 'Good prices and service. Wide variety of phones available. Staff is knowledgeable and helpful. Highly recommended!', product: null },
  { name: 'Kavitha Reddy', rating: 5, comment: 'Trusted shop since years. They gave me genuine accessories at very good price. Will definitely come back!', product: null },
  { name: 'Suresh Patil', rating: 5, comment: 'Professional staff! They helped me choose the right phone within my budget. Very happy with OnePlus they suggested.', product: null },
  { name: 'Anita Desai', rating: 4, comment: 'Great experience. Bought Realme GT 6T. Got good discount compared to online. After-sale service is also excellent.', product: null },
];
...
const seedDB = async () => {
  try {
    ...
    let admin = await User.findOne({ email: 'admin@ganapathi.com' });
    if (!admin) {
      admin = await User.create({ name: 'Admin', email: 'admin@ganapathi.com', password: 'admin123', role: 'admin' });
      console.log('✅ Admin user created: admin@ganapathi.com / admin123');
    }

    // Seed google-style reviews (not product-specific)
    const reviewsWithUser = googleReviews.map((r, index) => ({ ...r, user: admin._id, product: createdProducts[index]._id }));
    await Review.insertMany(reviewsWithUser);
    console.log(`✅ Seeded ${googleReviews.length} reviews`);

    console.log('\n🚀 Database seeded successfully!');
    console.log('📧 Admin login: admin@ganapathi.com | 🔑 Password: admin123');
    process.exit(0);
  } catch (err) {
